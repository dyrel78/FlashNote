...
<div class="container">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" placeholder="email@address.com" required><br><br>
        </div>
        <!-- Password -->
        <div class="form-group">
...
.noteable-note-input, .noteable-note-output {
    margin-bottom: 1rem;
    border: 1px solid #ccc;
    padding: 1rem;
    background-color: #f8f8f8;
...
.noteable-upload-pdf, .noteable-create-note, .noteable-save-note {
    padding: 0.5rem 1rem;
    background-color: #007BFF;
    color: white;
    border: none;
